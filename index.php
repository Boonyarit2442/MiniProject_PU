                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#<?="EditModel_".$i?>" id="edit_<?=$i?>">Edit</button></td>
                          <!-- Modal edit -->
                                          ...
                                          <div class="modal-body w-100 h-100">
                                              <form action="controler/indexControler.php" method="POST">
                                                  <div>
                                                      ...
                                                      <div id="INPUT_IDEDIT">
                                                          <label for="NAME_ID">ID</label>
                                                          <input type="text" name="NAME_ID" id="NAME_ID" value="<?=$Data[$i]['NAME_ID']?>"><br>
                                                      </div>
                                                      <div>
                                                          <label for="USER1">User</label>
                                                          <input type="text" name="USER1" id="USER1" value="<?=$Data[$i]['USER1']?>"><br>
                                                      </div>
                                                      <div>
                                                          <label for="PASSWORD">password</label>
                                                          <input type="text" name="PASSWORD" id="PASSWOES" value="<?=$Data[$i]['PASSWORD']?>"><br>
                                                      </div>
                                                      <div>
