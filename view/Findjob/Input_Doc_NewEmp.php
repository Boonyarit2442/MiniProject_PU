...
<html lang="en">
  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-light bg-primary">
      <div class="container-fluid d-flex justify-content-between">
        <a class="navbar-brand" href="http://203.188.54.9/~u6411800010"
          ...
          ><teext-y class="text-warning fw-bold ms-2">113</teext-y></a
        >
        <div>
          <a
            class="me-3 btn btn-warning"
            href="http://203.188.54.9/~u6411800010"
            >หางาน
            </a>
        </div>
      </div>
    ...
    <div class="container mb-3 mt-3 text-center">
      <img
        src="https://anistudy.com/home/images/lms/school_manager.png"
        class="m-2"
        width="130vw"
        alt=""
      />
      ...
      <div class="container w-50">
        <div class="ms-5 ps-4">
          <div>
            ...
            <input name="ID_POS" type="text" class="ms-5" style="width: 20vw; height: 3vh" />
          </div>
          <div class="mt-3">
        ...
        <div class="mt-3 text-center">
          ...
          <label for="SAL" class="ms-4">เงินเดือนที่ต้องการ</label>
          <input type="text" name="SAL" id="SAL" class="ms-3" />
        </div>
        <div class="w-100 text-center">
          <table class="table">
            <thead>
              <tr>
                <th scope="col">
                  <input type="checkbox" name="Pogramer" id="Pogramer" />
                </th>
